...
# Set AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, and AWS_DEFAULT_REGION in your .env file
# boto3 automatically picks them up from the environment
...
def download_all_files():
    ...
    DOWNLOADS_DIR = r'D:\NCSU\EM508\Project\Linux_Sentinel\backend\downloads'  # Use raw string to avoid escaping
